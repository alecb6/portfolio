...
export default function Profile() {
  return (
    <div className="grid grid-rows-[20px_2fr_2fr_20px] grid-cols-1 items-center justify-items-center min-h-screen pt-12">
      <Header />
      <div className="flex flex-col items-center gap-4 p-4 max-w-[600px] mt-10">
        ...
        <div className="relative w-[600px] h-[320px] rounded-lg flex flex-col items-center justify-center p-4">
